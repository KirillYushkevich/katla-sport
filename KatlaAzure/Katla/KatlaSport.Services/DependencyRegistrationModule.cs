...
namespace KatlaSport.Services
{
    ...
    public class DependencyRegistrationModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<HospitalManagment.DoctorService>().As<HospitalManagment.IDoctorService>();
            builder.RegisterType<HospitalManagment.DepartmentService>().As<HospitalManagment.IDepartmentService>();
            builder.RegisterType<HospitalManagment.PatientService>().As<HospitalManagment.IPatientService>();
